...
На прошлой практике я работал в компании ENS, которая занимается сборкой щитов управления

Большинство этих щитов предназначались для насосов. Там мы работали с частотными преобразователями (VFD) и собирали их с элементами — реле, контакторами, автоматическими выключателями И Т д
